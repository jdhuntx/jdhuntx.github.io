...
<table class="client-table">
    <tbody>
        ...
        <tr>
            <th>Skills</th>
            <td>VB.NET, .NET framework 2.0 (beta), ADO.NET, Windows Forms, XML, Oracle, PL/SQL, Visual Studio 2005 (beta), Windows 2003, IIS, Windows Authorization Manager</td>
        </tr>
    </tbody>
</table>
<p>
